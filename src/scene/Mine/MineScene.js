...
class MineScene extends Component {
        ...
        return (
            <View style={styles.header}>
                <View style={styles.userContainer}>
                    ...
                    <View>
                        <View style={{ flexDirection: 'row' }}>
                            <Heading1 style={{ color: 'white' }}>dudongge</Heading1>
    ...
    getDataList() {
        return (
            [
                [
                    { title: '我的钱包', subtitle: '10万', image: require('../../img/Mine/icon_mine_wallet@2x.png') },
                    { title: '余额', subtitle: '￥100000', image: require('../../img/Mine/icon_mine_balance@2x.png') },
                    { title: '抵用券', subtitle: '充点吧', image: require('../../img/Mine/icon_mine_voucher@2x.png') },
                ...
                [
                    ...
                    { title: '积分商城', subtitle: '积分兑换已开启', image: require('../../img/Mine/icon_mine_member@2x.png') }
                ],
                [
